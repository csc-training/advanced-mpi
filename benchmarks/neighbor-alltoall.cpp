...
int main(int argc, char **argv)
{
	...
	for (int i=0; i < ndims; i++) {
	  ...
	  MPI_Sendrecv(sendbuf.data() + sendslot, count, MPI_DOUBLE, nghbrs[i][0], 1, 
	  ...
	  MPI_Sendrecv(sendbuf.data() + sendslot, count, MPI_DOUBLE, nghbrs[i][1], 1, 
